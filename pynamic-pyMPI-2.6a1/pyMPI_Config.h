...
#define PYMPI_COMPILER_FLAGS "-g -O2 -fPIC -I/usr/apps/python2.7.1/include/pyMPI2.6 -I/collab/usr/gapps/python/chaos_5_x86_64_ib/opt-2.7.1/include/python2.7"

/* Replacement function for get_makefile_filename */
#define PYMPI_GET_MAKEFILE_FILENAME_DEF "def __parallel_get_makefile_filename(): return '/usr/apps/python2.7.1/lib/pyMPI2.6/augmentedMakefile'\n"
...
/* Installation prefix */
#define PYMPI_INCLUDEDIR "/usr/apps/python2.7.1/include/pyMPI2.6"

/* Use simplified isatty() */
#define PYMPI_ISATTY 1

/* Library location */
#define PYMPI_LIBDIR "/usr/apps/python2.7.1/lib/pyMPI2.6"

/* Name of the MPI enabled C compiler for linking */
#define PYMPI_LINKER "/usr/local/bin/mpiicc"

/* Extra link flags needed to build */
#define PYMPI_LINKER_FLAGS " -L/usr/apps/python2.7.1/lib/pyMPI2.6 -lpyMPI -lm  -L/usr/apps/python2.7.1/lib/python2.7/config -lpython2.7  -Xlinker -export-dynamic   -lpthread -ldl  -lutil  "
...
/* Installation prefix */
#define PYMPI_PREFIX "/usr/apps/python2.7.1"

/* Issue a newline after prompt */
#define PYMPI_PROMPT_NL 1

/* Directory where python library files live */
#define PYMPI_PYTHON_CONFIGDIR "/usr/apps/python2.7.1/lib/python2.7/config"

/* the "-l" name of python library */
#define PYMPI_PYTHON_LIBRARY "python2.7"

/* Sub versioning a=alpha, b=beta, .x=release */
#define PYMPI_RELEASE "a1"

/* Installation directory */
#define PYMPI_SITEDIR "/usr/apps/python2.7.1/lib/pyMPI2.6/site-packages"
